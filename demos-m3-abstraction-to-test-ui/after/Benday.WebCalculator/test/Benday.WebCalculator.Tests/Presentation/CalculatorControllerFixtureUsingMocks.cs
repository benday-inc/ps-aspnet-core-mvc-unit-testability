...
{
    [TestClass]
    public class CalculatorControllerFixtureUsingMocks
    {
        [TestInitialize]
        public void OnTestInitialize()
        {
            _SystemUnderTest = null;
            _CalculatorServiceInstance = null;
        }
        ...
        private MockCalculatorService _CalculatorServiceInstance;

        public const double DEFAULT_RETURN_VALUE = -1234;
        ...
        public void CalculatorController_Calculate_Add()
        {
            ...
            Assert.IsTrue(CalculatorServiceInstance.AddWasCalled,
        ...
        public void CalculatorController_Calculate_Subtract()
        {
            ...
            Assert.IsTrue(CalculatorServiceInstance.SubtractWasCalled,
                "Subtract should have been called.");
        ...
        public void CalculatorController_Calculate_Multiply()
        {
            ...
            Assert.IsTrue(CalculatorServiceInstance.MultiplyWasCalled,
                "Multiply should have been called.");
        ...
        public void CalculatorController_Calculate_Divide()
        {
            ...
            Assert.IsTrue(CalculatorServiceInstance.DivideWasCalled, 
                "Divide should have been called.");
        ...
        public void CalculatorController_Calculate_DivideByZero()
        {
            ...
            Assert.IsFalse(CalculatorServiceInstance.DivideWasCalled, 
                "Divide should not have been called.");
