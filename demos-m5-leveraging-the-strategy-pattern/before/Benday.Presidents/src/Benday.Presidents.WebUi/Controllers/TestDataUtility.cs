...
public class TestDataUtility
{
    ...
    private string MapPath(Microsoft.Extensions.Hosting.IHostingEnvironment env, string fromPath)
    {
        if (env == null)
    ...
    public void CreatePresidentTestData(Microsoft.Extensions.Hosting.IHostingEnvironment env)
    {
